...
/* HOW TO DESIGN A NEW COMPONENT? 
  ...
  3 - Do I need any member functions (aka. methods) or life cycle hooks?
...
class AuthRedirect extends React.Component {
  render() {
    ...
    if (pathname === routes.LOGIN_ROUTE || pathname === routes.SIGNUP_ROUTE || 
      ...
      // Zachary - if the user is logged in, we'll redirect him/her to the dashboard
    } else if (!token) { // Zachary - This is basically happens with EVERY OTHER ROUTE
      destinationRoute = routes.ROOT_ROUTE;
    }
    // Zachary - 3 cases: DASHBOARD or ROOT or null
    return (
      <div>
